...
var config_1 = require("./config"); // נתיב הייבוא לפי המיקום של `config.ts`
function scrape(companyId, startDate) {
    return __awaiter(this, void 0, void 0, function () {
        var options, compeny, cred, scraper, scrapeResult, e_1;
        var _a;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    options = {
                        ...
                        // headless: true,
                        storeFailureScreenShotPath: path_1.default.resolve("./", 'screenshots/failure.jpg'),
                    };
                    compeny = config_1.credentials.find(function (c) { return c.name === companyId; });
                    if (!compeny) {
                        throw new Error("No credentials found for company ".concat(companyId));
                    }
                    cred = {
                    ...
                    return [4 /*yield*/, scraper.scrape(cred)];
                case 1:
                ...
                case 2:
                    e_1 = _b.sent();
                    console.error("Scraping failed for the following reason: ".concat(e_1));
